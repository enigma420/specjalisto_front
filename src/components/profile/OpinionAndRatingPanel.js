...
import CreateOpinionButton from "../opinion/CreateOpinionButton";
import CommissionItem from "../commission/CommissionItem";
...
export default function OpinionAndRatingPanel() {
